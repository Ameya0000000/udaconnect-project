...
This will enable you to connect to the database at `localhost`. You should then be able to connect to `postgresql://localhost:5433/geoconnections`. This is assuming you use the built-in values in the deployment config map.
