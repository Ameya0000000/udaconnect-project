...
class ConnectionServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.SendConnection = channel.unary_unary(
                '/connection.ConnectionService/SendConnection',
...
def add_ConnectionServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SendConnection': grpc.unary_unary_rpc_method_handler(
                    servicer.SendConnection,
...
class ConnectionService(object):
    ...
    def SendConnection(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/connection.ConnectionService/SendConnection',
